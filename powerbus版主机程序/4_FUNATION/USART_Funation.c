...
void TonXunFaSong(USART_TypeDef* USARTx,u8 DianNaoFaSong_HuanCun[],u16 DianNaoFaSong_START_ADDR,u8 DianNaoFaSong_Len)    
{
	...
	crc16(CRC_HuanCun,DianNaoFaSong_Len);
	...
	USART_SendData(USARTx,CRC_H);
	USART_SendData(USARTx,CRC_L);
}
...
void ZhuJi_ShuJuChuLi2(void)
{
	for(ZhuJi_ShuJuChuLi2_i=0;ZhuJi_ShuJuChuLi2_i<5;ZhuJi_ShuJuChuLi2_i++)//轮询5个缓存通道
	{
		if(ZhiLin_ChangDu[DianNaoJieShou_HuanCun[ZhuJi_ShuJuChuLi2_i][0]-1]>4)//收到的数据长度达到指令长度
		{
			...
			{
				crc16(DianNaoJieShou_HuanCun[ZhuJi_ShuJuChuLi2_i],ZhiLin_ChangDu[DianNaoJieShou_HuanCun[ZhuJi_ShuJuChuLi2_i][0]-1]-4);
				if(DianNaoJieShou_HuanCun[ZhuJi_ShuJuChuLi2_i][ZhiLin_ChangDu[DianNaoJieShou_HuanCun[ZhuJi_ShuJuChuLi2_i][0]-1]-4]==CRC_H)
				{
					if(DianNaoJieShou_HuanCun[ZhuJi_ShuJuChuLi2_i][ZhiLin_ChangDu[DianNaoJieShou_HuanCun[ZhuJi_ShuJuChuLi2_i][0]-1]-3]==CRC_L)
					{
...
void ZhuJi2_ShuJuChuLi2(void)
{
	...
	{  
		if(ZhiLin2_ChangDu[DianNaoJieShou2_HuanCun[ZhuJi2_ShuJuChuLi2_i][0]-1]>4)
		{
			...
			{
				crc16(DianNaoJieShou2_HuanCun[ZhuJi2_ShuJuChuLi2_i],ZhiLin2_ChangDu[DianNaoJieShou2_HuanCun[ZhuJi2_ShuJuChuLi2_i][0]-1]-3);
				if(DianNaoJieShou2_HuanCun[ZhuJi2_ShuJuChuLi2_i][ZhiLin2_ChangDu[DianNaoJieShou2_HuanCun[ZhuJi2_ShuJuChuLi2_i][0]-1]-3]==CRC_H)
				{
					if(DianNaoJieShou2_HuanCun[ZhuJi2_ShuJuChuLi2_i][ZhiLin2_ChangDu[DianNaoJieShou2_HuanCun[ZhuJi2_ShuJuChuLi2_i][0]-1]-2]==CRC_L)
					{
